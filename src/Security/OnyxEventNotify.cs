...
public sealed class OnyxEventNotify : MonoBehaviour
{
        ...
        if (OnyxConfig.EventNotifyChat != null && OnyxConfig.EventNotifyChat.Value)
        {
            try
            {
                if (HudManager.Instance != null && HudManager.Instance.Chat != null && PlayerControl.LocalPlayer != null)
                    HudManager.Instance.Chat.AddChat(PlayerControl.LocalPlayer, "[Onyx] " + msg);
            }
            catch { }
        }
    }
    ...
    public void Update()
    {
        if (!On || OnyxConfig.NotifySabotage == null || !OnyxConfig.NotifySabotage.Value
    ...
    private static class VkPatch
    {
        ...
        {
            if (!On || OnyxConfig.NotifyVotekick == null || !OnyxConfig.NotifyVotekick.Value) return;
    ...
    private static class KillPatch
    {
        ...
        {
            if (!On || OnyxConfig.NotifyKill == null || !OnyxConfig.NotifyKill.Value || __instance == null || target == null) return;
    ...
    private static class MeetPatch
    {
        ...
        {
            if (!On || OnyxConfig.NotifyMeeting == null || !OnyxConfig.NotifyMeeting.Value) return;
    ...
    private static class EjectPatch
    {
        ...
        {
            if (!On || OnyxConfig.NotifyEject == null || !OnyxConfig.NotifyEject.Value || __instance == null) return;
            try
            {
