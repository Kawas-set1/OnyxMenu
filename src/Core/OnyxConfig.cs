...
internal static class OnyxConfig
{
    ...
    internal static void Bind(ConfigFile config)
    {
        ...
        NetCloneCount = config.Bind("Lobby", "NetCloneCount", 6, "Networked self-clones in a formation (1-100).");
        NetCloneCount.Value = Mathf.Clamp(NetCloneCount.Value, 1, 100);
        ...
        ThemeIndex = config.Bind("Interface", "ThemeIndex", 0, "Accent theme index (0 = orange default).");
