...
public sealed class OnyxTracers : MonoBehaviour
{
    ...
    private static void Box(Vector2 c, float hw, float hh, Color col)
    {
        ...
        OnyxStyle.FillRaw(new Rect(x, y, br, t));
        OnyxStyle.FillRaw(new Rect(x + w - br, y, br, t));
        OnyxStyle.FillRaw(new Rect(x, y + h - t, br, t));
        OnyxStyle.FillRaw(new Rect(x + w - br, y + h - t, br, t));
        OnyxStyle.FillRaw(new Rect(x, y, t, br));
        OnyxStyle.FillRaw(new Rect(x, y + h - br, t, br));
        OnyxStyle.FillRaw(new Rect(x + w - t, y, t, br));
        OnyxStyle.FillRaw(new Rect(x + w - t, y + h - br, t, br));
        GUI.color = prev;
    }
