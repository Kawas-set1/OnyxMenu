...
internal static class SkipAnim
{
    ...
    internal static void Thaw()
    {
        try
        {
            ...
            if (me == null) return;
            me.moveable = true;
            if (me.Data != null && me.Data.IsDead) return;
            if (me.Collider != null) me.Collider.enabled = true;
            if (me.MyPhysics != null && me.MyPhysics.gameObject != null)
                me.MyPhysics.gameObject.layer = LayerMask.NameToLayer("Players");
        }
        catch { }
    }
